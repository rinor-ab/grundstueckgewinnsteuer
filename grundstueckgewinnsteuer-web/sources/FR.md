...
|------|-----------|----------|
| Cantonal tax law | DStG FR Art. 74–86 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/fr-de.pdf) | ☐ |
...
|------|-------|--------|----------|
| Tax model | degressive | canton-meta.ts | ☐ |
| Bracket table / rate schedule | See `data/cantons/fr.json` | | ☐ |
| Top rate | ___% | | ☐ |
