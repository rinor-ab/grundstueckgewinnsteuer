...
|------|-----------|----------|
| Cantonal tax law | StG ZH §§ 216–235 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/zh-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/zh.json` | | ☐ |
| Top rate | ___% | | ☐ |
