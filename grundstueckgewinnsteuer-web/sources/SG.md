...
|------|-----------|----------|
| Cantonal tax law | StG SG Art. 127–143 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/sg-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/sg.json` | | ☐ |
| Top rate | ___% | | ☐ |
