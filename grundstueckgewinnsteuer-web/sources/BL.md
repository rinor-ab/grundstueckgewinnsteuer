# Canton Audit: BL – Basel-Landschaft
...
|------|-----------|----------|
| Cantonal tax law | StG BL §§ 62–78 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/bl-de.pdf) | ☐ |
...
|------|-------|--------|----------|
| Tax model | steuerfuss | canton-meta.ts | ☐ |
| Bracket table / rate schedule | See `data/cantons/bl.json` | | ☐ |
| Top rate | ___% | | ☐ |
