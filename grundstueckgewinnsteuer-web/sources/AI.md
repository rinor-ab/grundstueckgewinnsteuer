# Canton Audit: AI – Appenzell Innerrhoden
...
|------|-----------|----------|
| Cantonal tax law | StG AI Art. 61–72 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/ai-de.pdf) | ☐ |
...
|------|-------|--------|----------|
| Tax model | progressive | canton-meta.ts | ☐ |
| Bracket table / rate schedule | See `data/cantons/ai.json` | | ☐ |
| Top rate | ___% | | ☐ |
...
| Item | Status |
|------|--------|
| Uses Steuerfuss model? | ☐ To verify |
| Data file present? | N/A |
