...
|------|-----------|----------|
| Cantonal tax law | StG SO §§ 58–68 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/so-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/so.json` | | ☐ |
| Top rate | ___% | | ☐ |
