...
|------|-----------|----------|
| Cantonal tax law | StG GL Art. 63–74 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/gl-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/gl.json` | | ☐ |
| Top rate | ___% | | ☐ |
