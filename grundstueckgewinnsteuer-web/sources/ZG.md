...
|------|-----------|----------|
| Cantonal tax law | StG ZG §§ 42–48 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/zg-de.pdf) | ☐ |
...
|------|-------|--------|----------|
| Tax model | yield-rate | canton-meta.ts | ☐ |
| Bracket table / rate schedule | See `data/cantons/zg.json` | | ☐ |
| Top rate | ___% | | ☐ |
