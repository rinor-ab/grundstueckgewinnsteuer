...
|------|-----------|----------|
| Cantonal tax law | LI VD Art. 61–73 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/vd-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/vd.json` | | ☐ |
| Top rate | ___% | | ☐ |
