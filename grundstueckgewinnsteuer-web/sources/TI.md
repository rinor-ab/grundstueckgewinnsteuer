...
|------|-----------|----------|
| Cantonal tax law | LT TI Art. 123–135 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/ti-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/ti.json` | | ☐ |
| Top rate | ___% | | ☐ |
