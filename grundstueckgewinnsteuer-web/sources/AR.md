# Canton Audit: AR – Appenzell Ausserrhoden
...
|------|-----------|----------|
| Cantonal tax law | StG AR Art. 78–87 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/ar-de.pdf) | ☐ |
...
|------|-------|--------|----------|
| Tax model | flat-rate | canton-meta.ts | ☐ |
| Bracket table / rate schedule | See `data/cantons/ar.json` | | ☐ |
| Top rate | ___% | | ☐ |
