...
|------|-----------|----------|
| Cantonal tax law | StG AG §§ 101–112 | ☐ |
| GGSt-specific ordinance | | ☐ |
| Federal ESTV Kantonsblatt | [PDF](https://www.estv2.admin.ch/stp/kb/ag-de.pdf) | ☐ |
...
| Bracket table / rate schedule | See `data/cantons/ag.json` | | ☐ |
| Top rate | ___% | | ☐ |
